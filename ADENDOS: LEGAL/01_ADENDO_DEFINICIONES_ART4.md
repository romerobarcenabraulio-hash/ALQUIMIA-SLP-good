# ADENDO 1 — DEFINICIONES
## Artículo 4 (SLP) · Adición de fracciones al artículo de definiciones

**trace:** CLC-004-ADENDO-1  
**Fuente:** Sección 4.1 del Capítulo San Luis Potosí  
**Técnica:** Adicionar fracciones al artículo de definiciones vigente  
...
<!-- ═══════════════════════════════════════════════════════════════
     SECCIÓN PARA EL CSA:
     Cuando descargues el Reglamento de Aseo Público de SLP (2018),
     pega aquí el texto completo del Artículo 4 vigente.
     También puedes pegar la captura de pantalla del PDF en el sistema.
     ═══════════════════════════════════════════════════════════════ -->

**Reglamento:** Reglamento de Aseo Público del Municipio de San Luis Potosí (2018)  
**Artículo:** Art. 4 — Definiciones  
**Texto vigente:**
...
[PENDIENTE EXTRACCIÓN AGENTE: pegar aquí texto literal del Art. 4 desde el PDF oficial.]
```

**Referencia cruzada MTY (Reglamento de Limpia Municipal de Monterrey, 2020-2024):**  
**Artículo equivalente:** Art. 3 — Definiciones (35 fracciones verificadas)  
**Extracto relevante (fracciones VII, XVI, XXVI-XXIX):**
...
- NO distingue vivienda individual en calle de vivienda en condominio
- NO reconoce la figura de "administración de condominio"
- NO define "centro de acopio condominial"
- NO define "sistema de separación en fracciones"
- **Consecuencia:** los artículos posteriores (20 Bis, 21, 21 Bis, 37 Bis) no tienen sujeto jurídico definido al que asignar obligaciones ni sanciones

---

## ✏️ ADENDO PROPUESTO

**Instrumento:** Adición de fracciones al Artículo 4 del Reglamento de Aseo Público  
**Para SLP:** Adición de fracciones [X], [X+1], [X+2] y [X+3] al Art. 4  
*(Numeración exacta a confirmar una vez cotejado el texto íntegro del artículo vigente)*

---

Se adicionan las fracciones siguientes al Artículo 4 del Reglamento de Aseo Público del Municipio de San Luis Potosí, para quedar como sigue:
...
### Efecto operativo
Diferencia jurídicamente el universo de condominios del resto de la ciudad. Crea las cuatro figuras que usan los artículos 20 Bis, 21 Bis y 37 Bis para asignar obligaciones y sanciones. Sin estas definiciones, cualquier adendo posterior queda en el aire.

---

## Tabla de adaptación multi-ciudad

| Ciudad | Artículo de definiciones | Número de fracciones a adicionar | Nombre de la Dirección competente | Nombre de la ley de condominios estatal |
|---|---|---|---|---|
| **San Luis Potosí** | **Art. 4** | 4 fracciones nuevas | Dirección de Aseo Público | Ley sobre el Régimen de Propiedad en Condominio del Estado de SLP |
| **Querétaro** | **Art. [📄 VERIFICAR]** | 4 fracciones nuevas | `[📄 VERIFICAR nombre Dirección]` | Ley de Propiedad en Condominio del Estado de QRO `[VERIFICAR]` |
| **Monterrey** | **Art. [📄 VERIFICAR]** | 4 fracciones nuevas | `[📄 VERIFICAR nombre Dirección]` | Ley Condominios NL `[VERIFICAR]` |
| **San Pedro G.G.** | **Art. [📄 VERIFICAR]** | 4 fracciones nuevas | `[📄 VERIFICAR]` | Ley Condominios NL |
| **Soledad de G.S.** | Art. 1 (reglamento nuevo) | Artículo completo | Dirección de Aseo Público | Ley SLP |
| **Corregidora** | **Art. [📄 VERIFICAR]** | 4 fracciones nuevas | `[📄 VERIFICAR]` | Ley Condominios QRO |
| **El Marqués** | **Art. [📄 VERIFICAR]** | 4 fracciones nuevas | `[📄 VERIFICAR]` | Ley Condominios QRO |

> **Instrucción para el equipo:** cada `📄 VERIFICAR` se resuelve abriendo el PDF del reglamento de esa ciudad, localizando el capítulo de definiciones (normalmente Cap. I — Disposiciones Generales) y anotando el número de artículo. El texto de las 4 fracciones no cambia.

---

> **NOTA DE NO VINCULANCIA:** borrador consultivo CLC-ALQUIMIA. No produce efectos jurídicos hasta revisión por abogado con cédula y cotejo contra texto completo del reglamento base de cada ciudad.
