...
const MODULES_BY_STAGE: Record<ClientPlatformStage, Array<{ module_id: string; label: string }>> = {
  validation: [
    ...
    { module_id: 'M03', label: 'Capacidad institucional' },
    ...
    { module_id: 'M14', label: 'Riesgos y defensibilidad' },
    { module_id: 'M15', label: 'Paquete de decisión preliminar' },
  ],
  planning: [
    { module_id: 'M00', label: 'Resumen de planeación' },
    { module_id: 'M00B', label: 'Evidencia municipal disponible' },
    { module_id: 'M04', label: 'Costo de no actuar' },
    { module_id: 'M05', label: 'Captura privada urbana' },
    { module_id: 'M06', label: 'Flujo 100% RSU' },
    { module_id: 'M07', label: 'Centros, compradores y cobertura' },
    { module_id: 'M08', label: 'Operación y rutas' },
    { module_id: 'M09', label: 'Brechas documentales' },
    { module_id: 'M10', label: 'Matriz legal y cumplimiento' },
    { module_id: 'M11', label: 'Actores y gobernanza' },
    { module_id: 'M12', label: 'Sensibilidad técnica' },
    { module_id: 'M13', label: 'Escenarios financieros' },
    { module_id: 'M14', label: 'Riesgos' },
    { module_id: 'M15', label: 'Hoja de ruta institucional' },
  ],
  execution: [
    { module_id: 'M00', label: 'Resumen de ejecución' },
    { module_id: 'M15', label: 'Hoja de ruta activa' },
    ...
    { module_id: 'M19', label: 'Requests y cargas pendientes' },
    { module_id: 'M20', label: 'Evidencia nueva y recálculo' },
