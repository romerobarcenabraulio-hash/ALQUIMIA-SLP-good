...
export const CHAPTERS: ChapterDef[] = [
  {
    ...
    bgColor: '#EAF3DE',
    borderColor: '#C9DDB1',
    modulos: ['city_baseline', 'social_study', 'municipal_context'],
  ...
  },
  {
    ...
    bgColor: '#E8F0FA',
    borderColor: '#BDD7F5',
    modulos: ['future_goals', 'infrastructure_operations', 'logistica_operativa', 'costos_programa', 'market_traceability'],
  ...
  },
  {
    ...
    bgColor: '#FEF7E7',
    borderColor: '#F5DCA0',
    modulos: ['esquema_concesion', 'scenarios_export', 'risk_trends'],
...
/** Module number labels (00-15 for functionary, E1-E3 for entrepreneur). */
