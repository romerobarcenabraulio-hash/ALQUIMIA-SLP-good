...
export const RESULTADOS_SURFACE_REGISTRY: Record<keyof ResultadosCalculados, VariableSurfaceEntry> = {
  ...
  casosIRAEvitados: { ownerModuleId: 'city_baseline', label: 'Casos IRA evitados', alsoShownIn: ['evaluacion_socioeconomica'] },
  casosDengueEvitados: { ownerModuleId: 'city_baseline', label: 'Casos dengue evitados', alsoShownIn: ['evaluacion_socioeconomica'] },
