...
export const SOURCE_VERIFICATION_MATRIX: SourceVerificationRow[] = [
  {
    ...
    fuente: 'INEGI Censo de Población y Vivienda 2020 / catálogo municipal ALQUIMIA',
    urlOrPath: 'Poblacion_01.xlsx; API INEGI; snapshot municipal del simulador',
    status: 'condicionado',
    formula: 'Suma poblacional de municipios activos; si hay municipio explícito se usa su población de catálogo.',
    unidad: 'habitantes',
    accionCorrectiva: 'Cerrar conexión a API INEGI para consulta directa y registrar CVE_MUN en cada escenario.',
  ...
  },
  {
    ...
    fuente: 'INEGI Censo 2020 / tabulados de vivienda',
    urlOrPath: 'Vivienda_01.xlsx; Vivienda_02.xlsx',
    status: 'verificado',
