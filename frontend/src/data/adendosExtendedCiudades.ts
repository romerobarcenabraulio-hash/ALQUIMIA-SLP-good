...
const SOL = packNlReg({
  ...
  verif: 'Publicado 18-JUN-2013 según carátula; extracción de artículos pendiente la plataforma.',
...
const GDL = packNlReg({
  ...
  verif: 'PDFs en línea (gestión integral + aseo público); extracción de artículos pendiente la plataforma.',
...
const ZAP = packNlReg({
  ...
  verif: 'PDF Oct 2024 en línea; extracción de artículos pendiente la plataforma.',
...
const GUA = packNlReg({
  ...
  verif: 'PDF en línea; extracción de artículos pendiente la plataforma.',
...
const APO = packNlReg({
  ...
  verif: 'PDF SISTEC en línea; verificar ámbito municipal exacto; extracción pendiente de revisión.',
