            ...
            >
              ...
              <div className="flex-1 min-w-0">
                <div className="flex items-center gap-2 mb-0.5">
                  ...
                  {!role.available && (
                    <span className="inline-flex items-center px-2 py-0.5 rounded-full bg-[#F4F2ED] border border-[#E0DCD6] text-[9px] font-semibold uppercase tracking-[0.08em] text-[#A8A49C]">
                      Próximamente
                    </span>
                  )}
                  {isLoading && (
                    <span className="text-[10px] text-[#A8A49C] animate-pulse">Cargando…</span>
                  )}
                </div>
                <p className="text-[11px] text-[#6B6760] leading-snug">{role.description}</p>
              </div>
