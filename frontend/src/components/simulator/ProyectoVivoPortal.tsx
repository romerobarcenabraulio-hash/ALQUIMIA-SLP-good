        ...
        {activeTab === 'standards' && readiness && (
          <div className="space-y-5">
            ...
            <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-5">
              ...
              <div className="space-y-3">
                <ReadinessBar label={readiness.estandares.gri306.nombre} score={readiness.estandares.gri306.score_pct} codigo="GRI 306" />
                <ReadinessBar label={readiness.estandares.sasb.nombre}   score={readiness.estandares.sasb.score_pct}   codigo="SASB EM-WM" />
