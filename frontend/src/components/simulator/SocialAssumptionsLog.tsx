...
export function SocialAssumptionsLog({ persistence, _storageOverride }: SocialAssumptionsLogProps) {
  ...
  return (
    ...
    >
      <p className="text-[10px] uppercase tracking-[0.08em] text-[#6B6760]">Bitácora de supuestos</p>
      ...
      <div className="mt-4">
        ...
        {entries.length === 0 ? (
          <p
            data-testid="social-context-assumptions-empty"
            className="mt-2 rounded-[8px] border border-dashed border-[#E8E4DC] bg-[#FAFAF8] px-3 py-3 text-[12px] text-[#6B6760]"
          >
