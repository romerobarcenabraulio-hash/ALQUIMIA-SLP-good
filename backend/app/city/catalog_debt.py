...
# Mensaje corto coherente con UI y hub legal (Navigator 23.x): claves internas hasta CVE/MGN.
CATALOG_CVE_DEBT_NOTICE: str = (
    "Los identificadores municipiales en esta simulación son claves internas ALQUIMIA; el anclaje a CVE INEGI y "
