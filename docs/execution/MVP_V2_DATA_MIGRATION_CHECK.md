...
| `document_gaps` MVP | PASS | `backend/alembic/versions/20260531_0015_document_archive_tables.py`; `.venv/bin/alembic heads` | Migración Alembic dedicada existe y `0015_document_archive_tables` es head | No |
| `tenant_documents` MVP | PASS | `backend/alembic/versions/20260531_0015_document_archive_tables.py`; `.venv/bin/alembic heads` | Migración Alembic dedicada existe y `0015_document_archive_tables` es head | No |
...
Crear seed/procedimiento founder/admin para entorno productivo. La migración Alembic explícita para `document_gaps` y `tenant_documents` quedó creada en `0015_document_archive_tables`.
