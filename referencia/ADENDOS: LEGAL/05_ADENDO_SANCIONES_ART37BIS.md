# ADENDO 5 — FISCALIZACIÓN Y RÉGIMEN DE MULTAS
## Artículo 37 Bis (SLP) · Nuevo artículo — escalera de sanciones 4→8→12 UMAs

**trace:** CLC-008-ADENDO-5  
**Fuente:** Sección 4.4 y Sección 16 del Capítulo San Luis Potosí  
**Técnica:** Adicionar nuevo artículo Bis en el capítulo de infracciones y sanciones  
...
<!-- ═══════════════════════════════════════════════════════════════
     SECCIÓN PARA EL CSA:
     Pega aquí el texto del artículo de sanciones vigente del
     Reglamento de Aseo Público de SLP 2018. Busca el capítulo
     de infracciones y sanciones (probablemente Art. 10 o similar).
     También es útil agregar el texto relevante del Bando de
     Policía y Buen Gobierno al que remite el artículo actual.
     ═══════════════════════════════════════════════════════════════ -->

**Reglamento:** Reglamento de Aseo Público del Municipio de San Luis Potosí (2018)  
**Artículo de referencia:** Art. 10 / Art. 37 (sanciones — texto a confirmar)  
**Texto vigente:**
...
al Bando de Policía y Buen Gobierno del municipio."
```

**Referencia cruzada MTY (Reglamento de Limpia Municipal de Monterrey, 2020-2024):**  
**Artículos equivalentes:** Art. 54 (tipos de sanciones) + Art. 55 (Tabulador de Multas)

```
ARTÍCULO 54. Con independencia de las sanciones que señalan otros reglamentos municipales,
...
tabulador siguiente: [Tabulador de 52 supuestos con multas de 3 a 2,000 cuotas UMA según infracción]
```
Fuente: Reglamento de Limpia Municipal de Monterrey · Gobierno 2021-2024 · verificado íntegro
Diagnóstico MTY: Art. 54-55 tiene procedimiento completo con multas en UMA pero NO incluye escalera progresiva 3 niveles para separación condominial. Técnica normativa para MTY: reformar Art. 55 para añadir supuesto específico condominial con escalera 4→8→12 UMAs.

**Diagnóstico de la brecha:**
- El Bando no tipifica "entrega de residuos mezclados en condominios" como infracción autónoma
- No existe escalera progresiva de multas específica para separación de RSU
- No hay facultad expresa para documentar con evidencia fotográfica
- No hay sistema de folios ni de trazabilidad de expedientes de infracción
- **Consecuencia:** la norma sin sanción ejecutable es una sugerencia. Este artículo es la pieza que da dientes a todo el sistema.

---

## ✏️ ADENDO PROPUESTO

**Instrumento:** Nuevo Artículo 37 Bis del Reglamento de Aseo Público  
**Para SLP:** Artículo 37 Bis — nuevo, en el capítulo de infracciones y sanciones

---

**"Artículo 37 Bis. De la Fiscalización y Sanción por Incumplimiento de Separación.**
...
- Se notifica al habitante o a la administración del condominio.
- Registro en el sistema digital con folio único.
- **Sin costo económico.**
- Efecto: inicia el expediente del infractor.

**Nivel 2 — Advertencia formal (segundo incumplimiento del mismo tipo dentro de 30 días naturales):**
- Se emite advertencia escrita con plazo de corrección de 15 días hábiles.
- Registro en expediente.
- **Sin multa — registro acumulable para activar el Nivel 3.**

**Nivel 3 — Multa económica (tercer incumplimiento o reincidencia tras advertencia formal):**

| Infracción | Monto | Equivalencia aprox. (UMA 2026) |
|---|---|---|
...
La Dirección de Aseo Público emitirá los **lineamientos técnicos** para la documentación, resguardo y cadena de custodia de la evidencia, así como los protocolos de actuación del personal de recolección y supervisión, garantizando el respeto a los derechos de los habitantes y la protección de datos personales conforme a la Ley General de Protección de Datos Personales en Posesión de Sujetos Obligados.

Los recursos obtenidos por concepto de multas se destinarán preferentemente a programas de educación ambiental, adquisición de contenedores y mejora de la infraestructura de separación en los condominios del municipio."**

---

### Flujo operativo de cobro (Sección 16 del Capítulo SLP)

```
1. EVIDENCIA
   Inspector documenta: foto + GPS + tipo de falta + folio
          ↓
2. VALIDACIÓN
   Dirección de Aseo revisa evidencia → confirma falta → determina nivel
          ↓
3. FOLIO SANCIONADOR
   Se emite folio y se notifica al responsable (habitante o administración)
          ↓
4. PAGO
   El responsable cubre la multa en oficinas municipales o canal digital
          ↓
5. ESTADÍSTICAS
   Sistema registra: folios emitidos · advertencias · multas · pagos ·
   tasa de reincidencia → tablero del Promotor/Gestor
```

### Efecto operativo
Este artículo es la bisagra entre la norma y la realidad. Sin evidencia documentada no hay folio; sin folio no hay sanción; sin sanción no hay cambio de conducta. La escalera 4→8→12 UMAs es suficientemente progresiva para ser disuasiva sin ser confiscatoria. El Nivel 1 Aviso y Nivel 2 Advertencia protegen el debido proceso y reducen impugnaciones.

> **Nota CLC:** la multa no existe para recaudar — existe para cambiar conducta. Un sistema donde la multa se emite, se cobra y se registra genera disuasión. Un sistema donde se amenaza pero nunca se ejecuta genera cinismo.

---

## Tabla de adaptación multi-ciudad

| Ciudad | Artículo de sanciones vigente | Art. Bis propuesto | Estado actual |
|---|---|---|---|
| **San Luis Potosí** | Art. 10 (remite al Bando) | **Art. 37 Bis** | Muy débil — sin escalera específica RSU |
...
> **NOTA DE NO VINCULANCIA:** borrador consultivo CLC-ALQUIMIA. No produce efectos jurídicos. La escalera de multas (4-8-12 UMAs) requiere verificación contra los topes máximos de sanción que establezca el Bando de Policía y Buen Gobierno de cada municipio y, en su caso, la ley de ingresos municipal vigente.
