...
Punto de entrada para documentación operativa fuera del código fuente. El resto del repositorio vive en `frontend/`, `backend/`, `cursor-rules/`, etc.

## Trabajo activo

| Qué | Ruta |
|-----|------|
| Cola multi-agente (stub) | [`COLA_Y_ROLES_AGENTES.md`](../COLA_Y_ROLES_AGENTES.md) |
...
La carpeta `.obsidian/` es solo configuración local del vault; debe ignorarse en git (ver `.gitignore` en la raíz del repo).
